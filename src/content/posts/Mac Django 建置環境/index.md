...
cover: "./mac-django-environment-setup-png.jpg"
...
如果你還沒有安裝 Homebrew，可以按照以下指令來安裝。Homebrew 是 macOS 上的包管理器，方便你安裝和管理軟體：
...
1. 使用 `django-admin` 建立一個新專案。首先，進入你想要建立專案的目錄，然後執行以下指令：
